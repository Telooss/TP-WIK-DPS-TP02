...
Cela vous permettra de vérifier les vulnérabilités et les secrets dans cette image également.
...
Cela devrait être plus clair pour intégrer et exécuter les scans Trivy après la construction des images.


## Résultat Scan Trivy :
### 1 Layer :
```
telos@debian:~/tp-wik-dps-tp02/OneLayer$ sudo trivy image typescript-api-one
...
```
telos@debian:~/tp-wik-dps-tp02/OneLayer$ sudo trivy image typescript-api-two
